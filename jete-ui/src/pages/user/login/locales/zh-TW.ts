export default {
  ...
  'user-login.login.com.github.bacazy.jete.common.rpc.message-invalid-credentials': '賬戶或密碼錯誤（admin/ant.design）',
  'user-login.login.com.github.bacazy.jete.common.rpc.message-invalid-verification-code': '驗證碼錯誤',
