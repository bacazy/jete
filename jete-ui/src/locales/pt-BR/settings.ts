export default {
  ...
  'app.settings.basic.email-com.github.bacazy.jete.common.rpc.message': 'Por favor insira seu email!',
  'app.settings.basic.nickname': 'Nome de usuário',
  'app.settings.basic.nickname-com.github.bacazy.jete.common.rpc.message': 'Por favor insira seu nome de usuário!',
  'app.settings.basic.profile': 'Perfil pessoal',
  'app.settings.basic.profile-com.github.bacazy.jete.common.rpc.message': 'Por favor insira seu perfil pessoal!',
  'app.settings.basic.profile-placeholder': 'Breve introdução sua',
  'app.settings.basic.country': 'País/Região',
  'app.settings.basic.country-com.github.bacazy.jete.common.rpc.message': 'Por favor insira país!',
  'app.settings.basic.geographic': 'Província, estado ou cidade',
  'app.settings.basic.geographic-com.github.bacazy.jete.common.rpc.message': 'Por favor insira suas informações geográficas!',
  'app.settings.basic.address': 'Endereço',
  'app.settings.basic.address-com.github.bacazy.jete.common.rpc.message': 'Por favor insira seu endereço!',
  'app.settings.basic.phone': 'Número de telefone',
  'app.settings.basic.phone-com.github.bacazy.jete.common.rpc.message': 'Por favor insira seu número de telefone!',
