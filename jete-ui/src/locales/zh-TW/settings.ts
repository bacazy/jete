export default {
  ...
  'app.settings.basic.email-com.github.bacazy.jete.common.rpc.message': '請輸入您的郵箱!',
  'app.settings.basic.nickname': '昵稱',
  'app.settings.basic.nickname-com.github.bacazy.jete.common.rpc.message': '請輸入您的昵稱!',
  'app.settings.basic.profile': '個人簡介',
  'app.settings.basic.profile-com.github.bacazy.jete.common.rpc.message': '請輸入個人簡介!',
  'app.settings.basic.profile-placeholder': '個人簡介',
  'app.settings.basic.country': '國家/地區',
  'app.settings.basic.country-com.github.bacazy.jete.common.rpc.message': '請輸入您的國家或地區!',
  'app.settings.basic.geographic': '所在省市',
  'app.settings.basic.geographic-com.github.bacazy.jete.common.rpc.message': '請輸入您的所在省市!',
  'app.settings.basic.address': '街道地址',
  'app.settings.basic.address-com.github.bacazy.jete.common.rpc.message': '請輸入您的街道地址!',
  'app.settings.basic.phone': '聯系電話',
  'app.settings.basic.phone-com.github.bacazy.jete.common.rpc.message': '請輸入您的聯系電話!',
